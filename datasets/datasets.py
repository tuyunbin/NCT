def create_dataset(cfg, split='train'):
    ...
    if cfg.data.dataset == 'rcc_dataset':
        ...
        data_loader = RCCDataLoader(
            ...
            num_workers=cfg.data.num_workers,
            pin_memory=True)
    elif cfg.data.dataset == 'rcc_dataset_transformer_with_neg':
        from datasets.rcc_dataset_transformer_with_neg import RCCDataset, RCCDataLoader
        dataset = RCCDataset(cfg, split)
        data_loader = RCCDataLoader(
            dataset,
            batch_size=dataset.batch_size,
        ...
        data_loader = RCCDataLoader(
            ...
            num_workers=cfg.data.num_workers,
            pin_memory=True)
    elif cfg.data.dataset == 'rcc_dataset_transformer_with_dep_dc':
        from datasets.rcc_dataset_transformer_with_dep_dc import RCCDataset, RCCDataLoader
        dataset = RCCDataset(cfg, split)
        data_loader = RCCDataLoader(
            dataset,
            batch_size=dataset.batch_size,
            ...
            num_workers=cfg.data.num_workers,
            pin_memory=True)
    elif cfg.data.dataset == 'rcc_dataset_transformer_with_dep_spot':
        from datasets.rcc_dataset_transformer_with_dep_spot import RCCDataset, RCCDataLoader
        dataset = RCCDataset(cfg, split)
        data_loader = RCCDataLoader(
            dataset,
            batch_size=dataset.batch_size,
