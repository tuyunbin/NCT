...
while t < cfg.train.max_iter:
    ...
    for i, batch in enumerate(train_loader):
        ...
        # d_feats, sc_feats = \
        #     spatial_info(d_feats), spatial_info(sc_feats)
        ...
        loss_pos, _, attention_weight_pos, dep_loss = speaker._forward(encoder_output_pos,
                                                                           labels, deps, masks,
                                                                           labels_with_ignore=labels_with_ignore,
                                                                           deps_with_ignore=deps_with_ignore)
        ...
        total_loss = speaker_loss + 0.02 * dep_loss + 2.5e-03 * att_sum
