...
while t < cfg.train.max_iter:
    ...
    for i, batch in enumerate(train_loader):
        ...
        deps, deps_with_ignore = deps.to(device), deps_with_ignore.to(device)
        ...
        loss_pos, _, attention_weight, dep_loss = speaker._forward(encoder_output_pos,
        ...
        total_loss = speaker_loss + 0.001 * dep_loss + 2.5e-03 * att_sum
        ...
        if t % cfg.train.snapshot_interval == 0:
            ...
            with torch.no_grad():
                ...
                for val_i, val_batch in enumerate(val_loader):
                    d_feats, sc_feats, \
                    labels, labels_with_ignore, masks, \
                    d_img_paths, sc_img_paths, deps, deps_with_ignore = val_batch
                    ...
                    # speaker_output_neg = speaker.sample(encoder_output_neg)
