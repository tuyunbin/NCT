...
parser.add_argument('--input_captions_dep_json', default="./clevr_dc/change_captions_dep.json", help='input captions json file to process into hdf5')
...
parser.add_argument('--output_dep_vocab_json', default="./clevr_dc/transformer_dep_vocab.json", help='output vocab file')
